...
var TsColorConverter = (function () {
    ...
    TsColorConverter.prototype.HSBAtoRGBA = function (hsba) {
        var _this = this;
        var hue = new decimal_js_1.default(hsba.h);
        var saturation = new decimal_js_1.default(hsba.s).div(100);
        var brightness = new decimal_js_1.default(hsba.b).div(100);
        var chroma = new decimal_js_1.default(1)
            .minus(new decimal_js_1.default(brightness).times(2).minus(1).abs())
            .times(saturation);
        var huePrime = hue.div(60);
        var x = chroma.times(new decimal_js_1.default(1).minus(new decimal_js_1.default(huePrime.mod(2)).minus(1).abs()));
        var ranges = [
            [0, 1, [chroma, x, new decimal_js_1.default(0)]],
            [1, 2, [x, chroma, new decimal_js_1.default(0)]],
            [2, 3, [new decimal_js_1.default(0), chroma, x]],
            [3, 4, [new decimal_js_1.default(0), x, chroma]],
            [4, 5, [x, new decimal_js_1.default(0), chroma]],
            [5, 6, [chroma, new decimal_js_1.default(0), x]]
        ];
    ...
    TsColorConverter.prototype.RGBAToHSBA = function (rgba, alpha, returnAsString, hsl) {
        ...
        var r = new decimal_js_1.default(rgba.r).div(255);
        var g = new decimal_js_1.default(rgba.g).div(255);
        var b = new decimal_js_1.default(rgba.b).div(255);
        var max = decimal_js_1.default.max(r, g, b);
        var min = decimal_js_1.default.min(r, g, b);
        ...
        var saturation = luminance.lte(0.5)
            ? d.div(max.plus(min))
            : d.div(new decimal_js_1.default(2).minus(max.plus(min)));
        var hue = new decimal_js_1.default(0);
        if (max.equals(r)) {
            hue = g
                .minus(b)
                .div(d)
...
exports.default = TsColorConverter;
